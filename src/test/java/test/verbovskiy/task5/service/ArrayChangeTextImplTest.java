...
import com.verbovskiy.task5.service.impl.ArrayChangeTextImpl;
...
public class ArrayChangeTextImplTest {
    ArrayChangeTextImpl arrayChangeText;

    @BeforeClass
    public void setUp() {
    arrayChangeText = new ArrayChangeTextImpl();
    }
    ...
    public void replaceCharacterPositiveTest() throws TaskException {
        ...
        String actual = arrayChangeText.replaceCharacter(text,3,"&");
    ...
    public void splitTextOnWordExceptionTest() throws TaskException {
        arrayChangeText.replaceCharacter(null,-1,null);
    }

    @Test
    public void correctMistakePositiveTest() throws TaskException {
        String text = "PA PA PA PA";
        String actual = arrayChangeText.correctMistake(text,"PA","PO");
    ...
    public void correctMistakeExceptionTest() throws TaskException {
        arrayChangeText.correctMistake(null,null,null);
    }

    @Test
    public void replaceSubstringCertainLengthPositiveTest() throws TaskException {
        String text = "As he walked along, he glanced around him in occasional puzzlement.";
        String actual = arrayChangeText.replaceSubstringCertainLength(text,"&&&&",2);
    ...
    public void replaceSubstringCertainLengthExceptionTest() throws TaskException {
        arrayChangeText.replaceSubstringCertainLength(null,null,-1);
    }
}